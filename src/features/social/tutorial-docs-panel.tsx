...
const platformCards = [
    {
        ...
        notes: [
            "Use Page ID for page publishing.",
            "Do not rely on raw Page tokens as the long-term workflow.",
        ],
    },
    {
        title: "TikTok Video",
        ...
        notes: [
            "Manual tokens are for diagnostics only.",
            "Publish adapter should validate TikTok review and quota responses.",
        ],
    },
    {
        ...
        notes: [
            "Shop ID is needed for product/video mapping.",
            "Publish must validate product ownership and shop permissions.",
        ],
    },
];
                    ...
                    <article className="border border-main bg-secondary/20 p-4">
                        ...
                        <ol className="mt-4 grid gap-2 text-[12px] leading-5 text-muted">
                            {youtubeSetupSteps.map((step, index) => (
                                <li
                                    key={step}
                                    className="flex gap-3 border border-main bg-main p-3"
                                >
                        ...
                        <div className="mt-3 grid gap-3 md:grid-cols-2">
                            ...
                            <div className="border border-main bg-main p-3">
                                ...
                                <p className="mt-2 break-all font-mono text-[12px] text-main">
                                    ...
                                    /api/social/oauth/callback/youtube
                                </p>
                            </div>
                            <div className="border border-main bg-main p-3 md:col-span-2">
                                ...
                                <p className="mt-2 text-[12px] leading-5 text-main">
                                    OmniVideo blocks `youtube_short` when asset
                                    metadata is missing, duration is over 3
                                    minutes, or the video is horizontal. This
                                    avoids silently uploading a Shorts intent as
                                    a normal video.
                                </p>
                            </div>
                        </div>
