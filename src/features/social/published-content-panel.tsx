...
export function PublishedContentPanel({ section }: PublishedContentPanelProps) {
    ...
    const localRows = useMemo(
        () =>
            inventory.accounts.flatMap((account) =>
    ...
    const loadInventory = async () => {
        ...
        try {
            ...
            const payload =
                (await response.json()) as ApiResponse<InventoryPayload>;
                ...
                <div className="min-w-0 space-y-4">
                    <div>
                        ...
                        <p className="mt-1 text-[11px] leading-5 text-muted">
                            YouTube remote rows are fetched live from the
                            connected channel when OAuth scope allows it.
                        </p>
                    </div>

                    {localRows.length === 0 ? (
                        <div className="border border-main bg-secondary/20 px-4 py-6 text-[12px] text-muted">
                            Chưa có publish record nội bộ.
                        </div>
                    ) : (
                        <div className="border border-main overflow-x-auto">
                ...
                <aside className="min-w-0 space-y-4">
                    <div className="border border-main">
                        <div className="border-b border-main bg-secondary/30 px-4 py-3">
                            ...
                            <p className="mt-1 text-[11px] leading-5 text-muted">
                                Requires reconnecting YouTube with the read-only
                                inventory scope.
                            </p>
                        </div>
                            ...
                            {youtubeAccounts.length === 0 ? (
                                ...
                                youtubeAccounts.map((account) => (
                                    <div
                                        ...
                                        className="border-b border-main p-4"
                                    >
                                        ...
                                        <div className="mt-2 space-y-2">
                                            {(
                                                ...
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="block border border-main bg-secondary/15 hover:bg-secondary/35"
                                                >
                                                    <div className="flex">
                                                        {video.thumbnailUrl ? (
                                                        ...
                                                        <div className="min-w-0 p-2">
                                                            <p className="line-clamp-2 text-[11px] font-semibold text-main">
                                                                {video.title}
                                                            </p>
                    ...
                    <div className="border border-main">
                        <div className="border-b border-main bg-secondary/30 px-4 py-3">
                            ...
                            <p className="mt-1 text-[11px] leading-5 text-muted">
                                Mỗi asset bên dưới cho biết đã được plan/publish
                                lên account nào.
                            </p>
                        </div>
                        <div className="max-h-[520px] overflow-y-auto">
