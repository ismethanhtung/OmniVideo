    ...
    <section className="overflow-hidden border border-main bg-main">
      ...
      <div className="px-5 py-5">
        <div className="border border-dashed border-main bg-secondary/30 px-4 py-3">
          <p className="text-[12px] font-medium text-main">Not implemented yet</p>
          <p className="mt-1 text-[12px] leading-5 text-muted">
            Mục này đã được đăng ký trong leftbar. UI và logic riêng sẽ được triển
            khai trong feature module tương ứng, không viết trực tiếp vào
            `src/app/page.tsx`.
          </p>
        </div>
      </div>
