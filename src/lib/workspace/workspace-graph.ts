    ...
    },
    {
        ...
        configFields: [
            ...
            },
            {
                ...
                label: "Subtitle background padding Y",
                type: "number",
                required: false,
                defaultValue: 8,
            },
...
export function createUploadVipSaveLocalSampleGraph(): WorkspaceGraph {
    const now = new Date().toISOString();
    return {
        version: 1,
        draftId: "upload-vip-save-local-sample",
        title: "Upload -> VIP Processing -> Save Local",
        updatedAt: now,
        selectedNodeId: "source-file-1",
        nodes: [
            {
            ...
            {
                id: "output-download-local-1",
                templateNodeType: "output.download-local",
                label: "Save to local machine",
                position: { x: 940, y: 220 },
                config: {},
            },
        ],
        edges: [
            {
                id: "source-file-1:asset->video-vip-processing-1:asset",
                fromNodeId: "source-file-1",
                fromPortId: "asset",
                toNodeId: "video-vip-processing-1",
                toPortId: "asset",
            ...
            {
                id: "video-vip-processing-1:asset->output-download-local-1:asset",
                fromNodeId: "video-vip-processing-1",
                fromPortId: "asset",
                toNodeId: "output-download-local-1",
                toPortId: "asset",
            },
        ],
    };
